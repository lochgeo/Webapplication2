    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        InvoiceAccountId = c.Int(nullable: false, identity: true),
                        AccountNumber = c.String(nullable: false),
                        AccountName = c.String(nullable: false),
                        ApplicationUserId = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.InvoiceAccountId)
                .ForeignKey("dbo.AspNetUsers", t => t.ApplicationUserId)
                .Index(t => t.ApplicationUserId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.InvoiceAccounts", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Companies", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AccessCodes", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.InvoiceAccounts", new[] { "ApplicationUserId" });
            ...
            DropIndex("dbo.AccessCodes", new[] { "ApplicationUserId" });
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.InvoiceAccounts");
